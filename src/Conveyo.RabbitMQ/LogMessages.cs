...
{
    public const string InitialConnectionAttemptFailed = "Connecting to RabbitMQ at {Host} failed (attempt {Attempt}); retrying in {RetryDelay}.";
    public const string InitialConnectionFailed = "Connecting to RabbitMQ at {Host} failed after {Attempts} attempts over {Elapsed}; startup fails.";
